...
import tigerbackground from "../../../dist/characters/Anger.png";
...
const TigerDialogue = ({firstName}) => {
  const messages = [
    ...
    {
      type: "choice",
      text: `Oh, it looks like you already have the first ingredient! Do you need anything else, ${firstName}? (Press UP for yes, DOWN for no)`,
      yes: 1,
      no: 2,
    },
